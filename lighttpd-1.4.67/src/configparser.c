...
static void yy_destructor(YYCODETYPE yymajor, YYMINORTYPE *yypminor){
  switch( yymajor ){
    ...
    */
    ...
    case 27:
    case 28:
#line 377 "../../src/configparser.y"
{ buffer_free((yypminor->yy0)); }
#line 774 "./configparser.c"
      break;
    case 38:
#line 368 "../../src/configparser.y"
{ if ((yypminor->yy59)) (yypminor->yy59)->fn->free((yypminor->yy59)); }
#line 779 "./configparser.c"
      break;
    case 39:
...
#line 799 "./configparser.c"
      break;
    case 45:
#line 373 "../../src/configparser.y"
{ buffer_free((yypminor->yy9)); }
#line 804 "./configparser.c"
      break;
    case 46:
#line 374 "../../src/configparser.y"
{ buffer_free((yypminor->yy9)); }
...
#line 1185 "./configparser.c"
  yy_destructor(4,&yymsp[-1].minor);
        break;
      case 12:
#line 453 "../../src/configparser.y"
{
...
#line 1228 "./configparser.c"
        break;
      case 15:
#line 485 "../../src/configparser.y"
{
  yygotominor.yy59 = NULL;
  if (ctx->ok) {
...
#line 1256 "./configparser.c"
        break;
      case 16:
#line 510 "../../src/configparser.y"
{
...
#line 1405 "./configparser.c"
  yy_destructor(13,&yymsp[0].minor);
        break;
      case 29:
#line 613 "../../src/configparser.y"
{
  configparser_pop(ctx);
}
#line 1413 "./configparser.c"
...
#line 1439 "./configparser.c"
        /* No destructor defined for eols */
  yy_destructor(16,&yymsp[-1].minor);
        break;
      case 31:
#line 636 "../../src/configparser.y"
{
  yygotominor.yy18 = NULL;
  if (ctx->ok) {
    if (yymsp[-3].minor.yy18->context_ndx >= yymsp[0].minor.yy18->context_ndx) {
...
#line 725 "../../src/configparser.y"
{
  ...
  yymsp[0].minor.yy59->fn->free(yymsp[0].minor.yy59);
  yymsp[0].minor.yy59 = NULL;
}
...
#line 1586 "./configparser.c"
        break;
      case 37:
#line 750 "../../src/configparser.y"
{
  yygotominor.yy69 = CONFIG_COND_EQ;
}
#line 1593 "./configparser.c"
  yy_destructor(21,&yymsp[0].minor);
        break;
      case 38:
#line 753 "../../src/configparser.y"
{
  yygotominor.yy69 = CONFIG_COND_MATCH;
}
#line 1601 "./configparser.c"
  yy_destructor(22,&yymsp[0].minor);
        break;
      case 39:
#line 756 "../../src/configparser.y"
{
  yygotominor.yy69 = CONFIG_COND_NE;
}
#line 1609 "./configparser.c"
...
#line 1625 "./configparser.c"
  yy_destructor(25,&yymsp[0].minor);
        break;
      case 42:
#line 765 "../../src/configparser.y"
{
  yygotominor.yy69 = CONFIG_COND_SUFFIX;
}
#line 1633 "./configparser.c"
